...
import { getMovieDetails } from '../../../API calls/GetMovieData';
...
export const Card = ({ currMovie }) => {
  ...
  return (
    <div className="flex flex-col justify-between max-w-xs rounded-lg shadow-md bg-gray-200 dark:text-gray-800 p-4">
      {/* Image Section */}
